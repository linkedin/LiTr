...
public abstract class BaseDemoFragment extends Fragment {
    ...
    protected TransformationListener videoTransformationListener = new TransformationListener() {
        @Override
    ...
    protected abstract void transform(@NonNull Uri sourceVideoUri,
    ...
    @Nullable
    GlFilter createGlFilter(@NonNull Uri overlayUri, @NonNull PointF size, @NonNull PointF position, float rotation) {
    ...
    private void initClickListeners() {
        ...
        buttonTranscode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MediaFormat targetVideoFormat = createTargetVideoFormat(width, height, bitrate, keyFrameInterval);
                ...
                transform(sourceVideoUri, overlayUri, targetVideoFile, targetVideoFormat, targetAudioFormat);
            }
        });
    ...
    @Nullable
    private MediaFormat createTargetVideoFormat(int width, int height, int bitrate, int keyFrameInterval) {
