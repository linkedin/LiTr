...
/**
 * Four integer element vector shader parameter
 */
public class Uniform4iv extends ShaderParameter {
     ...
     */
    public Uniform4iv(@NonNull String name, int count, @NonNull int[] buffer) {
     ...
     * @param buffer buffer containing new vector values
     */
    public Uniform4iv(@NonNull String name, int count, @NonNull IntBuffer buffer) {
    ...
    public void apply(int glProgram) {
        GLES20.glUniform4iv(getLocation(glProgram), count, buffer);
    }
}
